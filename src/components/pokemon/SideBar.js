...
const FilterSidebar = ({ onFilterChange }) => {
    ...
    return (
        <div className="w-1/4 p-4">
            ...
            <div className="mb-4">
                <button className="w-full bg-black text-white py-2 px-4 rounded" onClick={handleFilterChange}>Apply Filters</button>
            </div>
            <div>
                <button className="w-full bg-white text-black border border-gray-300 py-2 px-4 rounded" onClick={() => {
                    setSelectedAbility('');
                    setSelectedTypes([]);
                    setSelectedHeight('');
                    setSelectedWeight('');
